...
export const metadata: Metadata = {
  ...
  title: "恋爱日记 V1.16 · 单人与共同体验",
  description: "恋爱日记 V1.16：单人与共同体验清晰分离，共同任务和重要日子由双方确认。",
  themeColor: "#fbfaf8",
  ...
  twitter: { card: "summary_large_image", title: "恋爱日记 V1.16 · 单人与共同体验", description: "共同任务和重要日子由双方确认。", images: ["/og.png"] },
};
