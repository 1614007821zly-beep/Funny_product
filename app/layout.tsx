...
export const metadata: Metadata = {
  ...
  title: "恋爱日记 V54 · 完整安排与回忆",
  description: "恋爱日记 V54：灵感路线可复现、共同完成需双方确认，回忆内容由用户自主分享与撤回。",
  themeColor: "#fbfaf8",
  ...
  twitter: { card: "summary_large_image", title: "恋爱日记 V54 · 完整安排与回忆", description: "灵感路线可复现，共同完成需双方确认，回忆由用户自主掌控。", images: ["/og.png"] },
};
