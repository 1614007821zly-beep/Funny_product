          ...
          <div className={`screen screen-${screen} ${hasRelationship?"":"solo-mode"}`}>
            ...
            {screen === "plan" && (
              <div className="page detail-page">
                ...
                <div className="sticky-cta"><button className="primary-button" onClick={() => {setScheduleDraft(draft => ({...draft, title: currentPlan.title}));go("confirm");}}>采用这个安排 <Arrow /></button><p>下一步确认日期与时间；确认前不会进入日历</p></div>
              </div>
            )}
