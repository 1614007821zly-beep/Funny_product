...
export default function Home() {
  ...
  function savePersonalPlan() {
    ...
    setSelectedDay(localDate(scheduleDraft.date).getDate()); setMonthOffset(0); setAdopted(true); setPartnerAccepted(false);
